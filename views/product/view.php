        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="left-sidebar">
                    ...
                    <ul class="category">
                        <?= \app\components\MenyWidget::widget(['tpl' => 'menu']) ?>
                    </ul>
                    <!--/category-products-->
                ...
                <div class="product-details"><!--product-details-->
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="product-information"><!--/product-information-->
                            ...
                            <?php endif;?>
                            <?php if ($product->new):?>
                                <?= \yii\helpers\Html::img('@web/images/home/new.png', [
                                    'alt' => $product->name,
                                    'class' => 'new'
                                ]) ?>
                            <?php endif;?>
                ...
                <div class="recommended_items"> -->
                    ...
                    <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <?php $length = count($hits); $counter = 0; foreach ($hits as $hit) : ?>
                                ...
                                <?php if (++$counter % 3 == 0 || $length == $counter): ?>
                                    </div>
                                <?php endif; ?>
